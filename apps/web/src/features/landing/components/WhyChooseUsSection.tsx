      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 xl:gap-24 items-center">
          <div className="lg:pr-8">
            ...
            <h3 className="font-outfit font-bold text-4xl md:text-5xl text-gray-900 mb-6 leading-tight">Why Choose Rescue Link</h3>
            <p className="text-lg md:text-xl text-gray-600 mb-10 leading-relaxed">
              We bridge the gap between residents and emergency services, providing a reliable technological foundation for public safety.
            </p>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
              {reasons.map((reason, index) => (
                <li key={index} className="flex items-start gap-4">
                  ...
                  <span className="text-base md:text-lg text-gray-700 font-medium leading-tight">{reason}</span>
                </li>
              ))}
            </ul>
          </div>
