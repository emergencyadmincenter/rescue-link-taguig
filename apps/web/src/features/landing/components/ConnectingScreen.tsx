        ...
        status === "rejected" ? (
          ...
          <>
            <div className="relative mb-8 w-24 h-24 flex items-center justify-center">
              ...
              <div className="absolute inset-0 border-[3px] border-danger/20 rounded-full animate-[ping_2.5s_cubic-bezier(0,0,0.2,1)_infinite] z-0" style={{ animationDelay: '0.5s' }}></div>
              <div className="absolute inset-0 border-[3px] border-danger/10 rounded-full animate-[ping_3s_cubic-bezier(0,0,0.2,1)_infinite] z-0" style={{ animationDelay: '1s' }}></div>
            ...
            <p className="body-medium text-gray-500 min-h-[48px] flex items-center justify-center">
              {statusMessage || "Please wait while we secure a connection with an available coordinator."}
            </p>
